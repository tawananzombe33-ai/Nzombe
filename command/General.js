...
zokou({ nomCom: "dev", categorie: "General", reaction: "⭐" }, async (dest, zk, commandeOptions) => {  
    ...
    const devs = [  
        { nom: "dev Mr b² 🍁🍁", numero: "255628848298" }  
    ];  
  
    let message = "WELCOME TO Mr b² 🍁🍁 HELP CENTER! ASK FOR HELP FROM THE DEVELOPER BELOW:\n\n";  
...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {  
    ...
    repondre("THANK YOU FOR CHOOSING Mr b² 🍁🍁, HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ GROUP LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z] \n\n ☉ GITHUB LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://github.com/side-smile/Ibupixel-] \n\n\n𝑴𝒂𝒅𝒆 𝒃𝒚 Mr b² 🍁🍁");  
